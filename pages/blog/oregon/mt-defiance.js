...
let metadata = {
  ...
  date: "2022-03-05",
  image:
    "https://lh3.googleusercontent.com/pw/AM-JKLUurR1iF-8zqOBfoQzGw8PMHNKTYAciJS09gTC2r--cchoXJ9To-ZXyjho6cEq8_Zpyu5_lDh6KskGe56fqeCDLADv9hF7FgneJnKD7Yvamkib6eT4Z2rU_kzk1LoKTzIzMLBIh7uKeXtdywLxcKPYt=s1067-no?authuser=0",
...
const img3 =
  "https://lh3.googleusercontent.com/pw/AM-JKLUYkB6TkGbyvpLgZQpIgt2EoGtM8k9nNnYjM2wIwxt1eDhT22sgbAb8cMKw283zEcB-KEIfO5KGddgKPottgORDU5DFOjPGjErfYOKrkBs769snwih1apFqpjkCdZgVehiPMfMmAHGA_gaelCip4pGX=w801-h1067-no?authuser=0";
  ...
  return (
    ...
    >
      <div className={utilStyles.flexGapContainer}>
        <div>
          <Link href={mtDefianceTrail}>{`Mt. Defiance`}</Link>
          {` is a steep hike to the tallest ridge in the Columbia River Gorge, starting at
          ...
          <div className={utilStyles.flexWrapContainer}>
            <Video src={rawData("IMG_3340.mp4")} width={300} height={450} />
            <Video src={rawData("IMG_3341.mp4")} width={300} height={450} />
            <Video src={rawData("IMG_3343.mp4")} width={300} height={450} />
          </div>
          <br />
          <br />
