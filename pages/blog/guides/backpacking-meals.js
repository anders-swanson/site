...
let metadata = {
  ...
  date: "2022-06-09",
  image:
    "https://lh3.googleusercontent.com/pw/AM-JKLVPvvDopK4LEy8vh-6RYP7G4pZxu8W2gbDSiBjXeFETMOat9i4INw8lXKv8rhqb6Baqf1MCoPKnsy9vd432BliVf1Hk5xquM85ZQeCSuDSxD2f0tp6u-PHaYh0SIPb7_7X7EymaRdQwgMMK6B3J9V2H=s450-no?authuser=0",
  ...
  return (
    ...
    >
      <div className={utilStyles.flexGapContainer}>
        ...
        <h1 className={utilStyles.justifyCenter} id="oatmeal">
          Oatmeal
        </h1>
        <br />
        <div>
          {`Oatmeal is the centerpiece of every breakfast (Yes, I mean `}
          <i>every</i>
          {` breakfast), and can be prepared easily in many ways.
          ...
          {`Add the ingredients to a ziplock bag for storage until preparation. Cook on camp stove using enough water to fully cover the oats.
                    ...
                    peanut butter (crunchy of course), granola, dried fruit, nuts, and `}
          <Link href={tvp}>TVP</Link>
          {`. You can put TVP on literally anything. 
        ...
        <h1 className={utilStyles.justifyCenter} id="pasta-and-couscous">
          Pasta or Couscous
        </h1>
        <br />
        <div>
          ...
          <ul>
            <li>
              Powdered cheese blends - you can buy these in bulk or use
              prepackaged mac boxes like Kraft
            </li>
            <li>
              Tuna Packets - literally add these to anything for extra protein
              and some calories
            </li>
            <li>TVP - almost goes without saying, and gives a nice crunch</li>
            <li>
              Powdered gravy mixes - found in the soup isle of your grocery
              store
            </li>
            <li>
              If you want to get crazy with it, a basic peanut sauce can be
              whipped up with peanut butter and soy sauce - Only for advanced
              adventurers
            </li>
          </ul>
        ...
        <h1 className={utilStyles.justifyCenter} id="pb-oreo-bagels">
          Peanut Butter Oreo Bagels
        </h1>
        <br />
        <div>
        ...
        <h1 className={utilStyles.justifyCenter} id="seafood-curry">
          Seafood Curry
        </h1>
        <br />
        <div>
          ...
          <ul>
            <li>
              <b>Day 1, Lunch:</b> Prepared sandwiches from home.
            </li>
            <li>
              <b>Day 1, Dinner:</b> 2 cups dry pasta with a powdered cheese
              blend and TVP.
            </li>
            <li>
              <b>Day 2, Breakfast:</b> 2 cups oatmeal with 2 Tablespoons instant
              milk powder, served with peanut butter and granola.
            </li>
            <li>
              <b>Day 2, Lunch:</b> Peanut butter bagels topped with oreos,
              supplemented with dried fruit and nuts.
            </li>
            <li>
              <b>Day 2, Dinner:</b> 2 cups minute rice with curry and tuna
              packets.
            </li>
            <li>
              <b>Day 3, Breakfast:</b> repeat oatmeal, mix up toppings
              (chocolate chunks, dried banana chips, peanut butter).
            </li>
            <li>
              <b>Day 3, Lunch:</b> Crackers (such as Triscuits) with cheese and
              dry salami, or repeat peanut butter bagels. Supplement lunch with
              remaining snacks, fruit, and nuts.
            </li>
          </ul>
