...
let metadata = {
  ...
  date: "2022-06-01",
  image:
    "https://lh3.googleusercontent.com/pw/AM-JKLWWJgfi_5SEW_Z1NGMGCA72m1-eVKoxRb6oTnkS-sDwpKEtHtgdXU-n8AnMkbch4AHcxJg8yHYWuIpFQ1OUZX0ZMRqcMoPkfObO2AhtElXjo6yj2CoM-swfhVPQ80UxktL_e494CkmUawdHActV9OZ9=s535-no?authuser=0",
  ...
  return (
    ...
    >
      <div className={utilStyles.flexGapContainer}>
        ...
        <h1 className={utilStyles.justifyCenter} id="big-indian-gorge">
          Big Indian Gorge
        </h1>
        <br />
        <div>
        ...
        <h1 className={utilStyles.justifyCenter} id="wildhorse-lake">
          Wildhorse Lake
        </h1>
        <br />
        <div>
        ...
        <h1 className={utilStyles.justifyCenter} id="little-blitzen">
        ...
        <h1 className={utilStyles.justifyCenter} id="alvord-desert">
          Alvord Desert
        </h1>
        <br />
        <div>
