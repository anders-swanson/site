    ...
    >
      <div className={utilStyles.flexGapContainer}>
        ...
        <div>
          ...
          <ul>
            <li>
              <Link href={meadowsCamp}>Meadow Campsite: </Link>
        ...
        <div>
          {`The Timberline Trail is most commonly hiker clockwise from `}
          <Link href={timberlineLodgeTrailhead}>Timberline Lodge</Link>
          {`, in 3-5 or more days. 
          ...
          <br />
          <br />
          <b>Clockwise from Timberline Lodge:</b>
          {`  camp at Ramona falls, Cairn Basin, Eden Park, or Elk Cove, Cloud Cap, and near Mt. Hood Meadows. For a 3
          ...
          <br />
          <b>Counter-Clockwise from Timberline Lodge:</b>
          {` Similar to the above, but in reverse. I like this route because you hike down to White River at the start,
                    rather than up at the end. The steep sand by White River is tiring to hike up.`}
          <br />
          <b>One Night from Cloud Cap:</b>
          {` This route can hardly be considered backpacking and the per-day milage is high, but it's still insanely fun.
