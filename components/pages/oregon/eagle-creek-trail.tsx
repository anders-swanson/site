...
export const metadata = {
  ...
  tags: ["waterfall", "hiking", "oregon", "columbia river gorge"],
  preview:
    "Experience the beauty of the Eagle Creek Trail and its cascading waterfalls in the Columbia River Gorge.",
};

export default function EagleCreek({ readMore = false }) {
  return (
    <>
      ...
      <div className={utilStyles.flexGapContainer}>
        <HikeInfo
          ...
          trailhead="https://www.google.com/maps/place/Eagle+Creek+Trailhead/@45.6372263,-121.9227969,16.42z/data=!4m5!3m4!1s0x5495a7b3fcbd403f:0x7e7ddf075caddc4c!8m2!3d45.6368482!4d-121.9194887"
