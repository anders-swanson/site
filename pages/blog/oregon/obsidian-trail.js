        ...
        >
            <div className={utilStyles.flexGapContainer}>
                <div>
                    ...
                    <Link href={CentralCascadesWildernessPermit}>the Forest Service</Link>{`. Besides the day permit, a Northwest Forest pass is also required to park at the
                    Obsidian Trailhead.`}
                    <br/><br/>
                ...
                <h1 className={utilStyles.justifyCenter} id='obsidian-trail'>Hiking the Obsidian Trail</h1>
                <br/>
                <div>
