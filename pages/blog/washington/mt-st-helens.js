...
const climbersBivouac = 'https://www.google.com/maps/place/Climbers+Bivouac+Trailhead/@46.146272,-122.1858107,17z/data=!3m1!4b1!4m5!3m4!1s0x54969c8ba8fbef91:0x2a76c011a0f90a6b!8m2!3d46.1462683!4d-122.183622'
const apeCaves = 'https://www.google.com/maps/place/Ape+Cave/@46.1096413,-122.2201436,15z/data=!3m1!4b1!4m5!3m4!1s0x54969d3823537baf:0xc9325f46a30596ca!8m2!3d46.1096273!4d-122.2113888'
    ...
    return (
        ...
        >
            <div className={utilStyles.flexGapContainer}>
                ...
                <h1 className={utilStyles.justifyCenter} id='permits'>Permits</h1>
                <div>
                    {`From April 1st to October 31st, all climbers must have a valid permit issued through `}<Link href={climbingPermits}>Recreation.gov</Link>
                    ...
                    <Video
                        height={600}
                        width={338}
                        src={rawData('IMG_1315.mp4')}
                    />
                    </div>
                </div>
                <h1 className={utilStyles.justifyCenter} id='climbing-guide'>Climbing Guide</h1>
                <br/>
                <div>
                    ...
                    water is recommend, and an electrolyte supplement like `}<Link href={links.misc.buoyElectrolytes}>Buoy</Link>{` will help to replenish lost salts and energy.`}
                </div>

                <h1 className={utilStyles.justifyCenter} id='tips'>Other Tips</h1>
                <br/>
                <div>
                    {`Exploring the nearby `}<Link href={apeCaves}>Ape Caves</Link>{` is a fun way to extend your trip. The Ape Caves
                    ...
                    <br/>
                    {`We brought our `}<Link href={links.misc.lumenaid}>Lumen Aid</Link>{` collapsable LED lantern with us, which was perfect for
                    ...
                    any trouble. Visit `}<Link href={apeCavesPermits}>Recreation.gov</Link>{` for information on permits for the caves.`}
                    <br/><br/>
