...
let metadata = {
  ...
  date: "2022-03-02",
  image:
    "https://lh3.googleusercontent.com/pw/AM-JKLVXZxDHctgqXuPbATiM-jc6EREPPKZX1EWEKvAZVll3-UrsXRkryL4M_jqVy1SWhb5PFoRg5VC9uM_s8w-lvgVA6uadfICSeY7vUM5oK-Md7TOAa-k0EmZozrocZoO7XYLnoZg4sEfumj_b_6O7ahcU=w1065-h1067-no?authuser=0",
...
const fallsMovie =
  "https://raw.githubusercontent.com/anders-swanson/data/master/data/IMG_3744.mp4";
const bluePool =
  "https://lh3.googleusercontent.com/pw/AM-JKLX_GHVW0uhxXwZba4YxWSV-mcMJle5pFPkYf-KN0ZyVIxNRHv1wxWLD2bkMUaKUGIJ_bScNFfSk679PQfydx-Lcb2Wd8gOGHfriQU-CVuUM_MeGgym494lKWTCHEtGQlVaJuDkUOQvzZZ4jTzzf0qiz=w801-h1067-no?authuser=0";
const bluePool2 =
  "https://lh3.googleusercontent.com/pw/AM-JKLUMAsVDY1oJFo11CULL74E_fJQh7zpzLC4pwiHXH8tLEW2_mt0OBSYQ4VQcGPcBAWxelcsd8vJMRhHjBX4qs0w1L4NAWEYAc3t8o90PiRUMYyI3ep5hxorh3CODaIahoaX0yR1oH8CoaRbdeuw-VaeE=w1597-h1067-no?authuser=0";
const clearLake =
  "https://lh3.googleusercontent.com/pw/AM-JKLW5fLbW4asNmRMUAv3e0QDeorjvomy0SmksAErMpsbCRxh2ArWIQPrZxm-7qzwiK5EU8U2BgZmNnXpqyT0KV9SlpYR7KomMg5lfyyZbMiPRtbAoyz1IjPKXmABD-EZu87cXCaB96c4mEYdvrEyOVJf1=w1597-h1067-no?authuser=0";
const bigelowSprings =
  "https://raw.githubusercontent.com/anders-swanson/data/master/data/IMG_3715.mp4";
  ...
  return (
    ...
    >
      <div className={utilStyles.flexGapContainer}>
        ...
        <Video src={bigelowSprings} height={450} width={300} />
        <div>
