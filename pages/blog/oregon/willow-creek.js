    ...
    >
      <div className={utilStyles.flexGapContainer}>
        <div className={utilStyles.textBlock}>
          Willow Creek hot springs is a remote springs on BLM land, located at a
          basic, walk-up,
          <Link href={campground}> free-to-use campground</Link>. Willow Creek
          is about an hour drive east from the town of Fields - the roads were
