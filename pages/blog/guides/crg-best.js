...
let metadata = {
  ...
  date: "2022-01-24",
  image:
    "https://lh3.googleusercontent.com/pw/AM-JKLXQvu4P9AMp_zEBWEPl5pko0vJHNNGVO5xhR3lrWLMmdZ3yPl-tMgDATjWqNttYm8RHlxVU2cLxq9PQtrj2XM9O8LYvVzK7hAg00kDOeLKdebZXNIX7IovMT3LVKgRJ1x1EbnQA3WcufZn0qJHItZTV=s1067-no?authuser=0",
  tags: ["hiking", "guides", "columbia river gorge", "oregon"],
};

const hamilton1 =
  "https://lh3.googleusercontent.com/pw/AM-JKLUVOemRvAGA8Nlxdhr_yhTK4HuQOENbAvI4E7e6OmOJCmpChtgfg5kFCYqD7YEFGy0sotPzv27hewXWwiukmvYVv83znU4cfdooGRIJFnZ-jauMN-AwpOnvVi19HnOJWqPuCaOFOaI1qdDFeXteohFU=w1912-h1075-no?authuser=0";
const hamilton2 =
  "https://lh3.googleusercontent.com/pw/AM-JKLXsofKgOfQR_zGJBBi9HvY-EbWIptBHEoHE5TUSbcXsx65KafDzOAYvyeAWrfXTHl0_yaNmO2_dsvvnVxHxZL0rbF6Npz4DHZh5x9ZfQhHTDRpiMeaJ-m64sAWuprBgJLHM9GnhHrZC97HQxHzLLEG8=w1912-h1075-no?authuser=0";
const table1 =
  "https://lh3.googleusercontent.com/pw/AM-JKLVq-74p75G-Jw8gCZ7O0ahSBMeNlhHbabo7QclRLGT2qDsGD43Pu32HOeCLSNm0ml7iMQ37kHJfNCrOQD7ZRcNA_RgpUS_JxNR1oFtnxyKD4h7RH5Uk2XCKzCOtJ2xiiVeSyq8tnjl5F2XLC5Sng0mn=w1912-h1075-no?authuser=0";
const table2 =
  "https://lh3.googleusercontent.com/pw/AM-JKLXkW7bZGe5Wj2ojKFqS10NbFLbg1wVPud3amS1-91wYHjPObM9rL2XDoY9HcJf1lJ6G8k8rzM_zvrmENYKq9HLSZshm3l6tWPHLPBcQdvYEWzvJuYhwI_RIOb2IhDcdzrgtAGLJCcUTKGHfVQzKhyr9=w1609-h1075-no?authuser=1";
const table3 =
  "https://lh3.googleusercontent.com/pw/AM-JKLV6p2wtw5-t_wDnzbM0uDyDk5yLirOiz_H6ko-luLA1fW3OEu1iNuim94cLJpRaHpCiIXcG2GW6xxzktc5r4b8VF3Kit5wGKkw3V1rhWDs38e6SOtodpM2ycvfYZPhnxk8_yOCx8KTrTc29TkrIOjYb=w1609-h1075-no?authuser=1";
const tunnelfalls =
...
const hamiltonTH =
  "https://www.google.com/maps/place/Hamilton+Mountain+Trailhead/@45.6347414,-122.0182306,15.5z/data=!4m5!3m4!1s0x5495e9ca4e5a2d5d:0x98cef5ae4083eb6!8m2!3d45.6327992!4d-122.020139";

const northBonnevilleTH =
  "https://www.google.com/maps/place/Parking+lot,+North+Bonneville,+WA+98648/@45.6509299,-121.9324613,17.5z/data=!4m5!3m4!1s0x5495e7c6efbe4257:0x623dc591efff77e2!8m2!3d45.6501388!4d-121.9337817";
const rockCreekPassTH =
  "https://www.google.com/maps/place/Rock+Creek+Pass+Trailhead/@45.7407168,-122.0130367,13.83z/data=!4m5!3m4!1s0x5495dbf96647c491:0x8419efe5bdeb97c5!8m2!3d45.74929!4d-122.0433";

const eagleCreekTH =
  "https://www.google.com/maps/place/Eagle+Creek+Trailhead/@45.6375551,-121.9187509,15.87z/data=!4m5!3m4!1s0x5495a7b3fcbd403f:0x7e7ddf075caddc4c!8m2!3d45.6367645!4d-121.9196042";
    ...
    >
      <div className={utilStyles.flexGapContainer}>
        ...
        <div className={utilStyles.flexWrapContainer}>
          <div>
            {`There are two main starting points for Hamilton mountain, from the `}
            <Link href={equestrianTH}>Equestrian Trailhead</Link>
            {`, 
                        or the `}
            <Link href={hamiltonTH}>Hamilton Mountain Trailhead</Link>
            {`. The latter is heavily used, and you will likely have 
          ...
          <Slider slides={[hamilton2, hamilton1]} width={1200} height={700} />
        </div>
        ...
        <div className={utilStyles.flexWrapContainer}>
          <div>
            {`A grueling, steep trek with gorgeous views from the summit, Table mountain can be approached from both the south and the north.
                        The south trailhead is located in `}
            <Link href={northBonnevilleTH}>North Bonneville</Link>
            {` and provides the easiest route to Table
            ...
            <br />
            <br />
            {`There are a couple of options for the north trailhead, the most accessible of which is probably `}
            <Link href={rockCreekPassTH}>Rock Creek Pass Trailhead</Link>
          ...
          <Slider slides={[table1, table3, table2]} width={1200} height={700} />
        </div>

        <h1 className={utilStyles.justifyCenter} id="eagle-creek">
          Eagle Creek to Tunnel Falls
        </h1>
        <div>
          {`In my opinion, Eagle Creek is truly `}
          <b>the</b>
          {` definitive gorge hike, standing out with its amazing waterfalls
                    and cliffs. The `}
          <Link href={eagleCreekTH}>trailhead at Eagle Creek</Link>
          {` fills up fast almost every day (even week days),
