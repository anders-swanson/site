...
let metadata = {
  ...
  date: "2022-02-16",
  image:
    "https://lh3.googleusercontent.com/pw/AM-JKLVsPHZLCQ6GFBOEdf31vfWweo6ukyR7nZDQ_78JqFA6Z6AQug5x3npOH8xKinKvnOUNmAuoB8TDOhz_njb_iL4arlL9uKE6443Hwuxd9usjJ-MDpHnEVueOVGy6GTT7oc7wfBwcI5B2066fEvl4auYS=w1167-h1067-no?authuser=0",
...
const bendGlacier =
  "https://lh3.googleusercontent.com/pw/AM-JKLVeewDw90rFw7BHRMoHFdNNLEhOGfoShjoRHS0hOjeKpZBdHLMkUDzFgQS7rl2xiDXUpMSyIbT6e7QXQojHBWfY9TbfXxZxw-JDkCKWXzdx1DG3HV0ci56ZeSeUkUUxzMwpkRKf5uH46Mz7Z-vgiPp6=w801-h1067-no?authuser=1";
const noNameLake =
  "https://lh3.googleusercontent.com/pw/AM-JKLXQ8buCaS2QtJXoI9jy6nk_CjBeN2I5l99kACm_M0nDziR6FUR-5ofzjK10YUlzXPNlrF_TsFXVzbvP4I02BWd6O4sPPKTovf_wMMan5WBERXgzym0q6-W2_61jfsGU_ZmJB-8yMwqknZdRP03IbQbw=w1597-h1067-no?authuser=1";
const laurenSummit =
  "https://lh3.googleusercontent.com/pw/AM-JKLXHMLS15QyADARXvB8DTVbvhZAh_Iqk69JjajLGU_DD7blDAHNJctd5MMSa6Ue9poUTgpFg8qqgwAbBO54YSFZB19GTKR9RSPZ5pQqAbddUd40XExQY26B-gaPDVTgtaZpsOduXpPdMCnPYvyafBf0p=w1423-h1067-no?authuser=1";
const teardropPool =
  "https://lh3.googleusercontent.com/pw/AM-JKLWIxMEYAEEW7cTJjip3nSfhfVI761lROkjWC3CcxCFEnNqjzXBOYBI9D8XAu_kQEXobnHGSbX8GV_gwN6dfv6eJioV2TrmV77tA-a52VL24royqWzk7Fo6NB87z4jyE2C19GQNSDKyPQMS2S8i0yH7U=w1597-h1067-no?authuser=1";
const summitView =
  "https://lh3.googleusercontent.com/pw/AM-JKLUD1AWWVFcr7OYY8LoingBXqwqcYKP_NdYF5mOnj0FX7zt5HUp2PAarYgmU97eqA_L7vaTv8TQNUEPd9Jd0e-Pt_vvZ8CkoA3Ngh9QXmjOKBtsIiOzd4tG42rZaLj4Qn246NDiwZX1jYkm_t4MP88QF=w1597-h1067-no?authuser=1";
      ...
      <div className={utilStyles.flexGapContainer}>
        <div className={utilStyles.textBlock}>
          {`South Sister and Broken Top are mountain peaks in Oregon's Three Sister's Wilderness, which are both accessible by day hikers.
                    South Sister is commonly summited via the `}
          <Link href={southSisterTrailhead}>{`Devil's Lake Trailhead`}</Link>
          {`, while Broken Top can be reached
                    from the Green Lakes, Todd Lake, Crater Ditch, or Broken Top trailheads.`}
          <br />
          <br />
          {`Both hikes are popular, and you should check ahead `}
          <Link href={CentralCascadesWildernessPermit}>for permits</Link>
        ...
        <div>
          ...
          {`The views from the summit are absolutely incredible, with the best found on the north side. Looking north, you can see the Middle and North Sisters,
                  ...
                  are a part of the `}
          <Link href="/blog/oregon/chambers-lakes">Chambers Lakes Basin</Link>
          {`, another beautiful are of the Three Sisters Wilderness`}
          <br />
          <br />
