...
let metadata = {
  ...
  date: "2022-03-20",
  image:
    "https://lh3.googleusercontent.com/pw/AM-JKLVYkpYYWiI4ZlOWasAHvsytICWO3KWORDCcKfNHRNUoH7fIGbZBN0lOLI-8oZBqY7ccnqaK5SIyZ39J_gdrTVh1nVGwHMBiudzKDjU6Ko9aItjDRKcIO4WEkP1DTaJeCTeMyJ2Z2wpqDsP1FwPwIZkR=s1067-no?authuser=0",
  ...
  return (
    ...
    >
      <div className={utilStyles.flexGapContainer}>
        <div>
          {`All the way out in Southeastern Utah you'll find the `}
          <Link href={needles}>Needles</Link>
          {`, a district of `}
          <Link href={clnp}>Canyonlands National Park</Link>
          {`. This is a gorgeous area to explore, and I specifically recommend
                    the Druid Arch hike.`}
          <br />
