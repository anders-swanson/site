      ...
      <div className={utilStyles.flexGapContainer}>
        ...
        <div>
          ...
          <div className={utilStyles.centered}>
            <Image
              alt="South Sister from Green Lakes, Central Oregon"
        ...
        <div className={utilStyles.centered}>
          <Image
            alt="Sunset illumintating Broken Top, Central Oregon"
        ...
        <div className={utilStyles.flexWrapContainer}>
          <div>
            ...
            <div className={utilStyles.centered}>
              <Image
                alt="Snowy Mt. Hood from Paradise Park, Oregon"
        ...
        <div>
          ...
          <div className={utilStyles.centered}>
            <Image
              alt="Mt. Adams from High Camp, Washington"
              width={600}
              height={400}
        ...
        <div>
          ...
          <div className={utilStyles.centered}>
            <Image
              alt="Flowers blooming at Canyon Creek Meadows, Oregon"
          ...
          <div className={utilStyles.centered}>
            <Image
              alt="Mt. Jefferson at Canyon Creek Meadows, Oregon"
