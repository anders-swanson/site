...
export default function WTPHiking({
  ...
  return (
    <>
      ...
      {`This is the gear I personally use for day hikes, having tested it over thousands of miles and multiple years.`}
      <div>
        {clothing && (
          <>
            <h3>Basics</h3>
        ...
        {food && (
          <>
            <h3>Food</h3>
            {`For all but the shortest day hikes, make sure to pack plenty of food. For me, this means any hike
                longer than 1-2 hours.
                Pack what you like to eat, and enough of it to keep you fueled for the day.`}
            ...
            <ul>
              ...
              <li>Nuts, crackers, chips, and other salty food</li>
              <li>Plenty of chocolate</li>
            </ul>
          </>
        )}
        {filterSystem && (
