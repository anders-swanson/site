...
let metadata = {
  ...
  date: "2022-04-14",
  image:
    "https://lh3.googleusercontent.com/pw/AM-JKLVh8DGmfxmPRACCPXJGASupjnMLPgNwdNzXlRYh6SyOiQTxknXNTT9ALfUekgx6ZQK8-HwScUe5XJikupggIjXO8-wNlTg2KaaZnSHrBI5f-yXWqbzDZEjGBVHKe1w1Zsp9pw89eC__MT7d2BVg9whm=w1069-h1067-no?authuser=0",
      ...
      <div className={utilStyles.flexGapContainer}>
        <div>
          ...
          {`Nestled beneath the summit of Steens Mountain is Wildhorse Lake, a picturesque cirque lake that can be accessed by a 
                    3 mile out-and-back from the `}
          <Link href={trailhead}> Summit trailhead</Link>
          {`. The descent to the lake is steep,
        ...
        <div>
          {`Also in the area is the Big Indian/Little Blizten Gorge hikes. These can be hiked in a loop (extremely difficult/backpackable), or individually. I recommend the 
                    Little Blizten Gorge, check out our `}
          <Link href="/blog/oregon/little-blitzen">post</Link>
          {` on it if you're considering the hike.`}
          <br />
          <br />
          ...
          <Link href="/blog/oregon/willow-creek">Willow Creek Hotsprings</Link>
          {` southeast of Fields. Both are gorgeous, remote, and unique areas.`}
        </div>
        <Image
          alt="Alvord Desert, Oregon"
          height={550}
          width={1000}
